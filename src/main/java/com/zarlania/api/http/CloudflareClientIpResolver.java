...
/**
 * {@link ClientIpResolver} for a deployment fronted by Cloudflare, which is what this service runs
 * behind today.
 *
 ...
 */
@Component
public class CloudflareClientIpResolver implements ClientIpResolver {
   ...
   * no suppression is needed; if that ever changes, this class's own documentation is the
   * justification.
   */
  @Override
  public String resolve(HttpServletRequest request) {
    return lastHeaderValue(request, CLOUDFLARE_CLIENT_IP_HEADER)
        .flatMap(CloudflareClientIpResolver::canonicalAddress)
