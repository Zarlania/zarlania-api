...
public record CredentialsProperties(Duration verificationTokenTtl, int maxConcurrentHashes) {
   ...
   * catching here.
   *
   * <p>Both messages name the property as it is written in configuration, not the record component
   ...
   * @throws IllegalArgumentException if {@code maxConcurrentHashes} is not at least one
   */
