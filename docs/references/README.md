...
| [000002](000002-authentication-and-tokens.md) | Authentication and tokens | How registration, login, JWT access tokens, refresh-token families, and email verification work end to end. | architecture, configuration, security |
<!-- reference-index:end -->
