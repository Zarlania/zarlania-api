...
| [000002](000002-authentication-and-tokens.md) | Authentication and tokens | How registration, email verification, login, JWT access tokens, refresh-token families, and the abuse defenses around them work end to end. | architecture, configuration, security |
<!-- reference-index:end -->
