...
| [000004](000004-request-throttling.md) | Request throttling | How the @Throttled aspect, its per-IP and per-account buckets, the configured endpoint limits, and the client-IP source that keys them work. | architecture, configuration, http, security |
<!-- reference-index:end -->
